...
import com.rich.myfirstapp.dummy.DummyContent;

/**
 * A list fragment representing a list of Patients. This fragment also supports
        ...
        getLoaderManager().initLoader(0, null, new LoaderCallbacks<Cursor>() {
            ...
            public Loader<Cursor> onCreateLoader(int id, Bundle args) {
                return new CursorLoader(getActivity(),
                        PatientProvider.URI_PATIENTS, Patient.FIELDS, null, null,
                        null);
            }
